  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="page-title mt-1">Conditional Access Policies</h1>
          ...
          <MotionItem>
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="card p-5">
                ...
                <AnimatedNumber value={items.filter((policy) => policy.state === "enabled").length} className="mt-2 block text-3xl font-bold tabular-nums text-emerald-600 dark:text-emerald-400" />
              </div>
              <div className="card p-5">
                <p className="eyebrow">Report-only</p>
                <AnimatedNumber value={items.filter((policy) => policy.state === "enabledForReportingButNotEnforced").length} className="mt-2 block text-3xl font-bold tabular-nums text-amber-600 dark:text-amber-400" />
              </div>
            </div>
          </MotionItem>
          <MotionItem>
